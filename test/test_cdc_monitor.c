...
void test_cdc_monitor(void)
{
    ...
    ks_monitor_t m = {
        .fmt = KS_MONITOR_FMT,
        .flags = KS_MON_F_HAS_RF | KS_MON_F_LINK_KBD | KS_MON_F_USB,
        ...
        .sig_kbd = 250, .sig_mouse = 200,
        .age_kbd_ms = 0x0102, .age_mouse_ms = 0x0304,
        .batt_kbd_dv = 41, .batt_kbd_soc = 92, .batt_kbd_chg = 1,
        .batt_mouse_dv = 38, .batt_mouse_soc = 60, .batt_mouse_chg = 0,
        .bt_slot = 2,
    };
    ...
    TEST_ASSERT_EQ(b[1], (KS_MON_F_HAS_RF|KS_MON_F_LINK_KBD|KS_MON_F_USB), "off1 flags");
    ...
    TEST_ASSERT_EQ(b[21], 41, "batt_kbd_dv");  TEST_ASSERT_EQ(b[22], 92, "batt_kbd_soc"); TEST_ASSERT_EQ(b[23], 1, "batt_kbd_chg");
    TEST_ASSERT_EQ(b[24], 38, "batt_mouse_dv");  TEST_ASSERT_EQ(b[25], 60, "batt_mouse_soc"); TEST_ASSERT_EQ(b[26], 0, "batt_mouse_chg");
